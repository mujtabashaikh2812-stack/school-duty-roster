      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        <div className="flex items-center justify-between pb-5 border-b border-slate-200">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-[#0f2b48] text-amber-400 flex items-center justify-center">
              <School className="w-5 h-5" />
            </div>
            <div>
              <h2 className="text-xl font-bold font-institutional text-slate-900">
                Institution & Letterhead Settings
              </h2>
              <p className="text-xs text-slate-500">
                Configure your school's official branding, academic term, and signature credentials for rosters.
              </p>
            </div>
          </div>
          ...
          <button
            type="button"
            onClick={handleReset}
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs text-slate-500 hover:text-slate-800 rounded-lg border border-slate-200 hover:bg-slate-50 transition-colors cursor-pointer"
          >
        ...
        <form onSubmit={handleSubmit} className="pt-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border border-slate-300 rounded-lg text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-600"
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30"
              />
            </div>
          ...
          <div className="pt-4 border-t border-slate-200 flex items-center justify-between">
            {savedSuccess ? (
              <span className="text-xs font-semibold text-emerald-700 flex items-center gap-1.5 bg-emerald-50 px-3 py-1.5 rounded-md border border-emerald-200">
                <Check className="w-4 h-4" />
                Settings saved successfully!
              </span>
            ) : (
              <span className="text-xs text-slate-400">Changes are saved to your browser automatically.</span>
            )}

            <button
              type="submit"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#0f2b48] hover:bg-[#163b63] text-white text-sm font-semibold rounded-lg shadow-sm transition-colors cursor-pointer"
            >
